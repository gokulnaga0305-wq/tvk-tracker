...
HARD_PRIORITY = [
    ...
    # Widened mapping — these concrete-crime/atrocity tags were being
    # dropped as "no hard category", losing real incidents (thefts,
    # extortion, ragging, self-immolation, illegal mining).
    ("theft",          "crime_law"),
    ("robbery",        "crime_law"),
    ("burglary",       "crime_law"),
    ("extortion",      "crime_law"),
    ("kidnap",         "crime_law"),
    ("ragging",        "crimes_women_kids"),
    ("youth",          "crime_law"),          # ragging/youth-violence items
    ("differently-abled", "civic_failure"),   # self-immolation / neglect
    ("mineral-smuggling", "corruption"),
    ("mineral-smuggli","corruption"),
    ("mining",         "corruption"),
    ("smuggling",      "corruption"),
    ("scam",           "corruption"),
    ("bribery",        "corruption"),
    ("fraud",          "corruption"),
    ("street-protests","civic_failure"),
    ("street-protest", "civic_failure"),
    ("protest",        "civic_failure"),
    ("attack-press",   "attack_on_press"),
    ("media-lackout",  "attack_on_press"),
    ("media-blackout", "attack_on_press"),
    ("crime",          "crime_law"),
    ("law-order",      "crime_law"),
    ("violence",       "crime_law"),
]
